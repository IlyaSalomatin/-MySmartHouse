...
{
    public class LivingRoom : Room, IAirHumidification, IAirConditioning, ISmartWindow, IFloorHeating, IOzonation, IThermometer
    {
        ...
        public LivingRoom(string name, double temperature, byte humidity)
            : base(name)
        {
